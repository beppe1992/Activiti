...
public class EseguiProcesso2 {

	public static void main(String [ ] args){

		String filenameConf = "./activiti.cfg.xml";
		String filenameProc = "./Processi/Processo2.bpmn";   ///NB!!The process definition XML file needs to end with .bpmn20.xml or .bpmn otherwise it's not parsed and deployed to the Activiti Engine.
		...
		variables.put("numeroDaValutare", new Integer(9));
		variables.put("soglia", new Integer(15));
		String procId = runtimeService.startProcessInstanceByKey("processo2",variables).getId();
